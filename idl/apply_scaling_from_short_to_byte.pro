...
FUNCTION apply_scaling_from_short_to_byte,$
         i_scale_factor,$
...
module_name = 'apply_scaling_from_short_to_byte:';
...
o_scale_factor = 40.0 / 254.0;   Should be 0.157480;

; Now solve for the o_add_offset using the new o_scale_factor.

o_add_offset = 20.0 - (127.0 * o_scale_factor);  Should be 0.0
...
;
;
; ( 4000/netCDF_DN ) = (127 /MODIS_L2P_DN)
;
; MODIS_L2P_DN/127.0 = netCDF_DN/4000.0
; MODIS_L2P_DN = (netCDF_DN/4000.0)* 127.0
;

array_index = 0;
total_elements = LONG(num_columns) * LONG(num_rows);
for array_index=0L,total_elements - 1 do begin
    o_byte_variable_array[array_index] = (i_short_variable_array[array_index] * i_scale_factor) / o_scale_factor;
endfor
