...
FUNCTION convert_additional_day_netcdf_variables,i_filename,i_out_filename,$
...
routine_name = "convert_additional_day_netcdf_variables";
msg_type = "";
msg = ""
i_data = "";
...
debug_module = 'convert_additional_day_netcdf_variables:';
debug_mode = 0
