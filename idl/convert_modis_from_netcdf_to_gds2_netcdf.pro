...
FUNCTION convert_modis_from_netcdf_to_gds2_netcdf,$
             i_filename,$
             i_out_filename,$
...
; Function convert a MODIS file from NetCDF4 format to NetCDF in GDS2 format.  This function is similiar to convert_modis_from_hdf_to_gds2_netcdf()
...
function_name = 'convert_modis_from_netcdf_to_gds2_netcdf:'
...
routine_name = "convert_modis_from_netcdf_to_gds2_netcdf";
msg_type = "";
msg = ""
i_data = "";
...
; Check if we are processing MODIS_T or not.  If it is and GHRSST_WRITE_COVERAGE_CONTENT_TYPE_FLAG is FALSE, we set it back to 2014 version.
granule_is_MODIS_T = 0;
if STRPOS(o_dsd_entry_id,"MODIS_T") GE 0 then begin
...
; Replace MODIS_A-JPL-L2P-v2014.0 with MODIS_A-JPL-L2P-v2016.2
...
;print, 'convert_modis_from_netcdf_to_gds2_netcdf: o_day_or_night = ', o_day_or_night; 

l_status = convert_additional_night_netcdf_variables_to_gds2(i_filename,i_out_filename,num_lons,$
               num_lats,i_convert_to_kelvin,$
               r_num_bad_scan_lines,$
               r_scan_line_flag_array,$
               i_test_parameter) 

l_status = convert_additional_day_netcdf_variables_to_gds2(i_filename,i_out_filename,$
               r_num_bad_scan_lines,$
               r_scan_line_flag_array,$
               i_test_parameter);
