...
FUNCTION convert_additional_night_netcdf_variables,i_filename,i_out_filename,$
             i_num_lons,$
             i_num_lats,$
             i_convert_to_kelvin, $
...
routine_name = "convert_additional_night_netcdf_variables";
msg_type = "";
msg = ""
i_data = "";

debug_module = 'convert_additional_night_netcdf_variables:';
debug_mode = 0
...
read_status = read_gds1_netcdf_one_variable(i_filename,i_variable_short_name,$
...
if (debug_mode) then begin
    print, 'i_filename ', i_filename, ' i_variable_short_name ', i_variable_short_name, ' variable_exist_flag ', variable_exist_flag, ' TEST_PARAMETER ', TEST_PARAMETER, ' read_status ', read_status
endif
...
if (read_status NE SUCCESS) then begin
    msg_type = "warning";
    ...
    ; Keep going
endif; end if ((read_status NE SUCCESS)
...
status = write_modis_data_variable(i_out_filename,$
    ...
    if (status EQ FAILURE) then begin
        msg_type = "warning";
