...
;
; $Id: convert_additional_day_hdf_variables.pro,v 1.8 2007/09/19 20:46:58 qchau Exp $
; DO NOT EDIT THE LINE ABOVE - IT IS AUTOMATICALLY GENERATED BY CVS
; New Request #xxxx

FUNCTION convert_additional_day_hdf_variables,i_filename,i_out_filename,$
                i_num_bad_scan_lines, $
                i_bad_scan_lines_array, $
                i_test_parameter

; Function convert additional HDF variables to NetCDF if the "Day or Night" is "Day"
;
...
routine_name = "convert_additional_day_hdf_variables";
msg_type = "";
msg = ""
i_data = "";
...
debug_module = 'convert_additional_day_hdf_variables:';
debug_mode = 0
