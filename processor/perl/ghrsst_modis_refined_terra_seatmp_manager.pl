...
#
# $Id: ghrsst_modis_refined_terra_seatmp_manager.pl,v 1.6 2007/09/19 20:46:58 qchau Exp $
# DO NOT EDIT THE LINE ABOVE - IT IS AUTOMATICALLY GENERATED BY CVS
# New Request #xxxx

#
#
# Program manages the GHRSST MODIS Refined Terra datasets by:
#
...
#  Call subroutine to manage the MODIS Terra sea surface temperature files.
...
my $use_cluster_flag = "LEAVE_ALONE_CLUSTER_IF_AVAILABLE";

ghrsst_modis_file_manager("sea_surface_temperature","MODIS_T",$ftp_push_flag,$compress_flag,
