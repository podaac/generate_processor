...
#
# $Id: ghrsst_modis_terra_seatmp_manager.sh,v 1.6 2007/11/14 00:04:34 qchau Exp $
# DO NOT EDIT THE LINE ABOVE - IT IS AUTOMATICALLY GENERATED BY CM
#
# C-shell script to start the Quicklook MODIS Terra processing script.
...
touch $PROCESSOR_LOGGING/my_crontab_log_from_ghrsst_modis_terra_seatmp_manager

perl $GHRSST_PERL_LIB_DIRECTORY/ghrsst_modis_terra_seatmp_manager.pl 15 yes >> $PROCESSOR_LOGGING/my_crontab_log_from_ghrsst_modis_terra_seatmp_manager
